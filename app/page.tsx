      ...
      <main>
        ...
        <section className="pb-24">
          <div className="zephyr-container">
            <div className="rounded-[2rem] border border-white/10 bg-zephyr-navy2 p-10 text-white shadow-zephyr-card md:p-14">
              <div className="max-w-3xl">
                ...
                <Link
                  href="/partner"
                  className="mt-9 inline-flex items-center rounded-full bg-zephyr-gold px-7 py-4 text-sm font-extrabold text-zephyr-navy shadow-gold transition hover:-translate-y-0.5 hover:bg-zephyr-goldSoft"
                >
