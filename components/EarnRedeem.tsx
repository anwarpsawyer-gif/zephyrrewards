          ...
          {items.map((item) => {
            ...
            return (
              <SectionReveal key={item.title}>
                <div className="group h-full rounded-[1.5rem] border border-white/10 bg-white p-7 text-zephyr-navy shadow-zephyr transition hover:-translate-y-1 hover:border-zephyr-gold/60">
                  ...
                  <p className="mt-3 leading-7 text-zephyr-navy/82">
                    {item.text}
                  </p>
                </div>
              </SectionReveal>
